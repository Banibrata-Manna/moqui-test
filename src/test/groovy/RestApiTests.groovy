...
class RestApiTests extends Specification {
    ...
    def cleanupSpec() {
        long totalTime = System.currentTimeMillis() - screenTest.test-componentTime
    ...
    @Unroll
    def "call test-component REST API (#requestMethod, #screenPath, #containsTextList)"() {
        expect:
        ...
        // Test test-component Rest API here
        // "put" | "s1/test-component/exampleendpoint" | [moquiSessionToken:token] | ['55800']
    }
}
